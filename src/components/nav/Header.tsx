...
export const Header = () => {
  return (
    <header className="h-[72px] px-4 flex items-center justify-between sticky top-0 z-20 bg-zinc-900/50 backdrop-blur-md">
      <MyLinks />
      <OutlineButton onClick={() => window.open("/https://res.cloudinary.com/bforbilly24/image/upload/v1754369983/Clear_Portfolio_Muhammad_Daniel_Krisna_Halim_Putra.pdf_ijzrof.pdf")}>
        My Resume
      </OutlineButton>
    </header>
  );
